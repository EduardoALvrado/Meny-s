...
function loadPedidos() {
    ...
    if (allOrders.length === 0) {
        container.innerHTML = '<p style="text-align: center; padding: 40px; color: #999;">No hay pedidos</p>';
        return;
    }
    ...
    allOrders.forEach((pedido, index) => {
        ...
        if (pedido.tipoEntrega === 'domicilio') {
            ...
            entregaHTML = `
                <div class="pedido-delivery">
                    <div class="pedido-delivery-type">🏍️ Didi Food</div>
                </div>
            `;
        }
        ...
        pedidoCard.innerHTML = `
            ...
            <div class="pedido-body">
                ...
                <div style="font-size: 0.85em; color: #999;">${pedido.fecha}</div>
            </div>
...
function filterPedidos() {
    ...
    if (filtered.length === 0) {
        container.innerHTML = '<p style="text-align: center; padding: 40px; color: #999;">No hay pedidos de este tipo</p>';
        return;
    }
...
function renderCreateMenu() {
    ...
    itemsToShow.forEach(item => {
        ...
        menuItem.innerHTML = `
            <div class="menu-item-create-icon">🍴</div>
...
function updateCreateCartDisplay() {
    ...
    if (adminCart.length === 0) {
        cartContainer.innerHTML = '<p style="text-align: center; color: #999;">No hay productos seleccionados</p>';
        updateCreateTotals();
        return;
    }
